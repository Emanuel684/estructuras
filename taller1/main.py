...
if __name__ == "__main__":
    # Implementar un método main donde se haga una prueba unitaria de cada
    # una de las operaciones: Unión, diferencia, intersección, diferencia
    # simétrica e equals. En sus pruebas unitarias verificar que el resultado es
    # correcto y validar que el conjunto no tenga elementos repetidos.

    # Creamos una nueva lista
    llist = Conjunto()

    # Agregamos nodos a la lista
    llist.insertar_inicio("a")  # [a]
    llist.insertar_final("b")  # [a, b]
    llist.insertar_inicio("c")  # [c, a, b]
    llist.insertar_final("d")  # [c, a, b, d]
    llist.insertar_final("y")  # [c, a, b, d, y]
    llist.insertar_final("y")  # [c, a, b, d, y]
    llist.insertar_final("y")  # [c, a, b, d, y]
    llist.insertar_final("x")  # [c, a, b, d, y, x]
    llist.insertar_final("x")  # [c, a, b, d, y, x]
    llist.insertar_inicio("c")  # [c, a, b, d, y, x]
    llist.insertar_inicio("p")  # [p, c, a, b, d, y, x]
    llist.insertar_inicio("p")  # [p, c, a, b, d, y, x]
    ...
    # Agregamos nodos a la lista
    llist2.insertar_final("a")  # [a]
    llist2.insertar_final("b")  # [a, b]
    llist2.insertar_inicio("c")  # [a, b, c]
    llist2.insertar_final("d")  # [a, b, c, d]
    llist2.insertar_final("x")  # [a, b, c, x]
    llist2.insertar_final("z")  # [a, b, c, z]

    # hashCode
    print("////////////////////////////////////////")

    print("llist: ", hash(llist))
    print("llist2: ", hash(llist2))
    ...
    assert str(llist) == "pcabdyx"
    assert str(llist2) == "cabdxz"
    ...
    print("Conjunto validar:")
    new_list = llist.__validar__()

    print("Conjunto printLL Validar:")
    print(new_list)
    ...
    print("Tamaño de linkedlist 1:", llist.__sizeof__())
    print("Tamaño de linkedlist 2:", llist2.__sizeof__())

    assert llist.__sizeof__() == 7
    assert llist2.__sizeof__() == 6
    ...
    new_list = llist.union(llist2)

    print("Conjunto printLL:")

    print(new_list)
    assert str(new_list) == "cabdxzpy"
    ...
    new_list = llist.diferencia(llist2)

    print("Conjunto printLL Diferencia:")

    print(new_list)
    assert str(new_list) == "py"

    print("Conjunto diferencia reverso:")
    new_list = llist2.diferencia(llist)

    print("Conjunto printLL Diferencia Reverso:")

    print(new_list)
    assert str(new_list) == "z"
    ...
    new_list = llist.interseccion(llist2)

    print("Conjunto printLL:")
    print(new_list)

    assert str(new_list) == "cabdx"
    ...
    print("Conjunto diferencia Simetrica:")
    new_list = llist.diferencia_simetrica(llist2)

    print("Conjunto printLL Diferencia Simetrica:")
    print(new_list)

    assert str(new_list) == "pyz"
